...
class OnPremiseAuthenticatorServiceTest: XCTestCase {
    ...
    func testRefreshToken() async throws {
        ...
        // Where
        let service = OnPremiseAuthenticatorService(with: "wxt272", refreshUri: URL(string: "\(urlBase)/mga/sps/oauth/oauth20/token")!, transactionUri: URL(string: "\(urlBase)/scim/Me")!, clientId: "abc123", authenticatorId: UUID())
    ...
    func testCertificateTrustFailedWithRefresh() async throws {
        ...
        // Where
        let service = OnPremiseAuthenticatorService(with: "wxt272", refreshUri: URL(string: "\(urlBase)/mga/sps/oauth/oauth20/token")!, transactionUri: URL(string: "\(urlBase)/scim/Me")!, clientId: "abc123", authenticatorId: UUID(), certificateTrust: pinnedCertificate)
    ...
    func testSelfSignedCertificateTrustWithRefresh() async throws {
        ...
        // Where
        let service = OnPremiseAuthenticatorService(with: "wxt272", refreshUri: URL(string: "\(urlBase)/mga/sps/oauth/oauth20/token")!, transactionUri: URL(string: "\(urlBase)/scim/Me")!, clientId: "abc123", authenticatorId: UUID(), certificateTrust: SelfSignedCertificateDelegate())
    ...
    func testNextTransaction() async throws {
        ...
        let service = OnPremiseAuthenticatorService(with: authenticator.token.accessToken, refreshUri: authenticator.refreshUri, transactionUri: authenticator.transactionUri, clientId: authenticator.clientId, authenticatorId: UUID(uuidString: "296C632A-E142-413E-9CDE-B547A1258BA8")!)
    ...
    func testPerformLoginFailed() async throws {
        ...
        // Where
        let service = CloudAuthenticatorService(with: "abc123", refreshUri: URL(string: "\(urlBase)/v1.0/")!, transactionUri:  URL(string: "\(urlBase)/v1.0/")!, authenticatorId: UUID())
