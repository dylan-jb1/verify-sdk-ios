...
class CloudAuthenticatorServiceTest: XCTestCase {
    ...
    func testCertificateTrustFailedWithRefresh() async throws {
        ...
        // Where
        let service = CloudAuthenticatorService(with: "abc123", refreshUri: registrationUrl, transactionUri: URL(string: "\(urlBase)/v1.0/")!, authenticatorId: UUID(), certificateTrust: pinnedCertificate)
    ...
    func testRefreshToken() async throws {
        ...
        // Where
        let service = CloudAuthenticatorService(with: "abc123", refreshUri: registrationUrl, transactionUri: URL(string: "\(urlBase)/v1.0/")!, authenticatorId: UUID())
    ...
    func testNextTransactionWithID() async throws {
        ...
        // Where
        let service = CloudAuthenticatorService(with: "abc123", refreshUri: URL(string: "\(urlBase)/v1.0/")!, transactionUri: transactionUrl, authenticatorId: UUID())
