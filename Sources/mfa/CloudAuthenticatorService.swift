...
public actor CloudAuthenticatorService: MFAServiceDescriptor {
    ...
    public init(with accessToken: String, refreshUri: URL, transactionUri: URL, authenticatorId: UUID, certificateTrust: URLSessionDelegate? = nil) {
    ...
    public func completeTransaction(action userAction: UserAction = .verify, signedData: String) async throws {
        ...
        // Only verify operations do we pass the signedData.
